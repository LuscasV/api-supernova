...
from .views import RegisterView, AddressListCreateView, MyAddressesView, AddressDetailView, AddToWishlistView, WishlistListView, RemoveWishlistView, VerifyEmailView, MyTokenObtainPairView
